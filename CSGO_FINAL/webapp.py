...
def on_message(ws, message):
    ...
    # if msg["reset"] == "reset":
    #     register_dir = glob.glob(os.path.join(r"C:\CSGO_FINAL\register", "*.jpg"))
    ...
    if method == "user":
        ...
        # cv2.imwrite(
        #     r"C:\CSGO_FINAL\register\\" + str(user_id) + r".jpg", results[0]["im"]
        # )

        # img = cv2.imread(r"C:\CSGO_FINAL\register\\" + str(user_id) + r".jpg")
        ...
        cv2.imwrite(
            r"C:\CSGO_FINAL\register\\" + str(user_id) + r".jpg", crop_img[y1:y2, x1:x2]
        )

        # lower, upper = get_color_range(img)

        # obj = {"user_id": user_id, "lower": lower, "upper": upper}
        # file_name = r"C:\CSGO_FINAL\colors\\" + str(user_id) + r".txt"
        ...
        # img = cv2.imread(r"C:\CSGO_FINAL\register\6435e2d04ee8e2528a60202f.jpg")
        ...
        cv2.imwrite(
            r"C:\CSGO_FINAL\crops\\" + str(user_id) + r".jpg",
            crop_img[
        ...
        cv2.imwrite(r"C:\CSGO_FINAL\shots\\" + str(user_id) + r".jpg", ims)
        # cv2.imshow("preview", ims)
        # cv2.waitKey()

        # final prediction of who got shot:

        all_players = glob.glob(os.path.join(r"C:\CSGO_FINAL\register", "*.jpg"))
        ...
        crop_img = cv2.imread(r"C:\CSGO_FINAL\crops\\" + str(user_id) + r".jpg")
        ...
        os.remove(r"C:\CSGO_FINAL\crops\\" + str(user_id) + r".jpg")
...
def register():
    ...
    if request.files.get("image"):
        ...
        cv2.imwrite(
            r"C:\CSGO_FINAL\results\\" + str(user_id) + r".jpg",
...
if __name__ == "__main__":
    model = torch.hub.load(
        r"C:\CSGO_FINAL\yolov5",
        "custom",
        path=r"C:\CSGO_FINAL\yolov5\runs\train\exp\weights\best.pt",
        source="local",
    )  # local repo
