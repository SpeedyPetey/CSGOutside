...
app.post('/send_shot', function(req, res) {
  ...
  // console.log(shots);
  image = newShot.Data;
  const path = 'C:/All/Homework/Year_3_2021-2023/Term_2/CPEN_391/l2a-08-bitsonebyte/testing/my-app2/server/shot.png'; // the path where you want to save the image
